...
import profilePic from "../assets/Alan/Guitar_Sunset.jpg";
import AlanResume from "../assets/Alan/AlanBanks_FullStack_2025.pdf";
...
const Intro = () => {
    return (
        <div id={SectionIDs.HOME} className="h border-b border-neutral-900 dark:border-b-MacbookMidnight pb-6 md:mt-12 mt-24">
            <div className="flex flex-wrap">
                ...
                <div className="w-full lg:w-1/2 lg:p-8">
                    <div className="flex justify-center">
                        <div className="overflow-hidden w-full lg:w-auto mt-16" style={{ height: "500px" }}>
                            <motion.img
                                variants={AnimationVariants(100, 1.1)}
                                initial="HIDDEN_STATE"
                                animate="VISIBLE_STATE"
                                className="w-full h-full object-cover object-bottom rounded-[3rem]"
                                src={profilePic}
